...
due to the behavior policy. These returns have the wrong expectation $E [ G _ { t } | S _ { t }   =   s ] = v _ { b } ( s )$ and so cannot be averaged 
...
$$
E [ \rho _ { t : T - 1 } G _ { t } | S _ { t } \mathop { = } s ] = v _ { \pi } ( s )
$$
...
$$
V ( s ) = \frac { \sum _ { t \in \mathcal { T } ( s ) } \rho _ { t : T ( t ) - 1 } G _ { t } } { | \mathcal { T } ( s ) | }
$$
...
$$
V ( s ) = \frac { \sum _ { t \in \mathcal { T } ( s ) } \rho _ { t : T ( t ) - 1 } G _ { t } } { \sum _ { t \in \mathcal { T } ( s ) } \rho _ { t : T ( t ) - 1 } }
$$
